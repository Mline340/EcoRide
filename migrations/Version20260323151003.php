 ...
 */
final class Version20260323151003 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, covoiturage_id INT NOT NULL, passager_id INT NOT NULL, date_reservation DATETIME NOT NULL, statut VARCHAR(255) NOT NULL, INDEX IDX_42C8495562671590 (covoiturage_id), INDEX IDX_42C8495571A51189 (passager_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
